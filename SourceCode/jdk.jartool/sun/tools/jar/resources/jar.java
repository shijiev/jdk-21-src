...
public final class jar extends ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "main.help.opt.main.create", "  -c, --create               Create the archive. When the archive file name specified\n                             by -f or --file contains a path, missing parent directories\n                             will also be created" },
            ...
            { "warn.flag.is.deprecated", "Warning: The {0} option is deprecated, and may be ignored or removed in a future release\n" },
            { "warn.index.is.ignored", "The JAR index (META-INF/INDEX.LIST) is ignored at run-time since JDK 18" },
